...
struct MD5Sum< ::av_msgs::VehicleMsg_<ContainerAllocator> >
{
  ...
  {
    return "a0af1fb5c8e3ba97ad6e7bf3ebe7aed9";
  }

  static const char* value(const ::av_msgs::VehicleMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa0af1fb5c8e3ba97ULL;
  static const uint64_t static_value2 = 0xad6e7bf3ebe7aed9ULL;
};
