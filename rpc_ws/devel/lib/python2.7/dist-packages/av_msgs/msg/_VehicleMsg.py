...
class VehicleMsg(genpy.Message):
  _md5sum = "a0af1fb5c8e3ba97ad6e7bf3ebe7aed9"
...
"""
  __slots__ = ['id','VehicleSpeedValid','Wheelspeed_RL','Wheelspeed_RR','Wheelspeed_RL_Valid','Wheelspeed_RR_Valid','VehicleSpeed','YawRate','LatAcceleration','LongAcceleration','EngineSpeed','EngineIdleSpeed','STAT_AcceleratorpedalPosition','STAT_AcceleratorPosRaw','Torsion_Bar_Torque','SteeringAngle','Steering_Angle_Speed']
  _slot_types = ['uint64','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,VehicleSpeedValid,Wheelspeed_RL,Wheelspeed_RR,Wheelspeed_RL_Valid,Wheelspeed_RR_Valid,VehicleSpeed,YawRate,LatAcceleration,LongAcceleration,EngineSpeed,EngineIdleSpeed,STAT_AcceleratorpedalPosition,STAT_AcceleratorPosRaw,Torsion_Bar_Torque,SteeringAngle,Steering_Angle_Speed
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_Q16f.pack(_x.id, _x.VehicleSpeedValid, _x.Wheelspeed_RL, _x.Wheelspeed_RR, _x.Wheelspeed_RL_Valid, _x.Wheelspeed_RR_Valid, _x.VehicleSpeed, _x.YawRate, _x.LatAcceleration, _x.LongAcceleration, _x.EngineSpeed, _x.EngineIdleSpeed, _x.STAT_AcceleratorpedalPosition, _x.STAT_AcceleratorPosRaw, _x.Torsion_Bar_Torque, _x.SteeringAngle, _x.Steering_Angle_Speed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.VehicleSpeedValid, _x.Wheelspeed_RL, _x.Wheelspeed_RR, _x.Wheelspeed_RL_Valid, _x.Wheelspeed_RR_Valid, _x.VehicleSpeed, _x.YawRate, _x.LatAcceleration, _x.LongAcceleration, _x.EngineSpeed, _x.EngineIdleSpeed, _x.STAT_AcceleratorpedalPosition, _x.STAT_AcceleratorPosRaw, _x.Torsion_Bar_Torque, _x.SteeringAngle, _x.Steering_Angle_Speed,) = _struct_Q16f.unpack(str[start:end])
      return self
