...
"""autogenerated by genpy from av_msgs/TrafficLight.msg. Do not edit."""
import sys
...
class TrafficLight(genpy.Message):
  _md5sum = "12e6ff6aa826247c71e4c2bc2f9e6414"
  _type = "av_msgs/TrafficLight"
...
#置信度
"""
  __slots__ = ['id','type','status','time','confidence']
  _slot_types = ['uint8','uint8','uint8','uint8','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,type,status,time,confidence
