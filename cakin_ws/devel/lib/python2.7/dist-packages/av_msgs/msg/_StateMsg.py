...
"""autogenerated by genpy from av_msgs/StateMsg.msg. Do not edit."""
import sys
...
class StateMsg(genpy.Message):
  _md5sum = "5e1c97c16ac2d6dd75321897f22255e6"
  _type = "av_msgs/StateMsg"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """uint64 id                   #id
string name                 #name
uint64 state                #state
"""
  __slots__ = ['id','name','state']
  _slot_types = ['uint64','string','uint64']
