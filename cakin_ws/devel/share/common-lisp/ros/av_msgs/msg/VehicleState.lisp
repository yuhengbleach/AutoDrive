...
(cl:defmethod cl:initialize-instance :after ((m <VehicleState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VehicleState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name av_msgs-msg:<VehicleState> is deprecated: use av_msgs-msg:VehicleState instead.")))
...
(cl:defmethod ang-val ((m <VehicleState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader av_msgs-msg:ang-val is deprecated.  Use av_msgs-msg:ang instead.")
  (ang m))
...
(cl:defmethod vel_ang-val ((m <VehicleState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader av_msgs-msg:vel_ang-val is deprecated.  Use av_msgs-msg:vel_ang instead.")
  (vel_ang m))
...
(cl:ensure-generic-function 'acc_ang-val :lambda-list '(m))
(cl:defmethod acc_ang-val ((m <VehicleState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader av_msgs-msg:acc_ang-val is deprecated.  Use av_msgs-msg:acc_ang instead.")
  (acc_ang m))

(cl:ensure-generic-function 'ref_curvature-val :lambda-list '(m))
(cl:defmethod ref_curvature-val ((m <VehicleState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader av_msgs-msg:ref_curvature-val is deprecated.  Use av_msgs-msg:ref_curvature instead.")
  (ref_curvature m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VehicleState>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'acc_y))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'acc_ang))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VehicleState>) istream)
  "Deserializes a message object of type '<VehicleState>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'acc_ang) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VehicleState>)))
  ...
  "cf167c65e8246be405f6d862a2d02a6d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VehicleState)))
  "Returns md5sum for a message object of type 'VehicleState"
  "cf167c65e8246be405f6d862a2d02a6d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VehicleState>)))
  ...
  (cl:format cl:nil "uint64 timestamp~%float64 x~%float64 y~%float64 ang~%float64 vel_x~%float64 vel_y~%float64 vel_ang~%float64 acc_x~%float64 acc_y~%float64 acc_ang~%float64 ref_curvature~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VehicleState)))
  "Returns full string definition for message of type 'VehicleState"
  (cl:format cl:nil "uint64 timestamp~%float64 x~%float64 y~%float64 ang~%float64 vel_x~%float64 vel_y~%float64 vel_ang~%float64 acc_x~%float64 acc_y~%float64 acc_ang~%float64 ref_curvature~%~%~%"))
