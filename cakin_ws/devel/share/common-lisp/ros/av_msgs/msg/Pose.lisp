...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name av_msgs-msg:<Pose> is deprecated: use av_msgs-msg:Pose instead.")))
...
(cl:defmethod theta-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader av_msgs-msg:theta-val is deprecated.  Use av_msgs-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'curvature-val :lambda-list '(m))
(cl:defmethod curvature-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader av_msgs-msg:curvature-val is deprecated.  Use av_msgs-msg:curvature instead.")
  (curvature m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Pose>)))
  ...
  "0b505a0e63316b91a76662fa8302f48a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Pose)))
  "Returns md5sum for a message object of type 'Pose"
  "0b505a0e63316b91a76662fa8302f48a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Pose>)))
  ...
  (cl:format cl:nil "# 时间戳~%uint64 timestamp~%# 轨迹x坐标~%float64 x~%# 轨迹y坐标~%float64 y~%# 轨迹朝向角坐标~%float64 theta~%# 曲率~%float64 curvature~%# 速度~%float64 velocity~%# 加速度~%float64 acceleration~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Pose)))
  "Returns full string definition for message of type 'Pose"
  (cl:format cl:nil "# 时间戳~%uint64 timestamp~%# 轨迹x坐标~%float64 x~%# 轨迹y坐标~%float64 y~%# 轨迹朝向角坐标~%float64 theta~%# 曲率~%float64 curvature~%# 速度~%float64 velocity~%# 加速度~%float64 acceleration~%~%~%"))
